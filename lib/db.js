...
`);
  ...
  `);
  await pool.query(`ALTER TABLE purchases ADD COLUMN IF NOT EXISTS referral_code VARCHAR(50);`);
  await pool.query(`ALTER TABLE referrals ADD COLUMN IF NOT EXISTS discount_percent INTEGER;`);
  await pool.query(`ALTER TABLE referrals ADD COLUMN IF NOT EXISTS new_price NUMERIC(10,2);`);
